...
},{"underscore":"../node_modules/underscore/underscore.js","jquery":"../node_modules/jquery/dist/jquery.js"}],"../src/controller.js":[function(require,module,exports) {
...
module.exports = Backbone.View.extend({
	...
	add: function add(modal) {
		if (this.modals.length > 0) this.modals[this.modals.length - 1].$el.before(modal.$el);else this.$el.before(modal.$el);
	...
	remove: function remove(modal) {
		...
		if (indx >= 0) this.modals.splice(indx, 1);
	...
	closeFirst: function closeFirst() {
		if (this.modals.length > 0) _.first(this.modals).close();
	},

	closeLast: function closeLast() {
		if (this.modals.length > 0) _.last(this.modals).close();
	}
...
var SPEED = 300; /* keep in sync with CSS */
var KEY_CODE_MAP = {
	27: 'esc',
	13: 'enter',
	8: 'delete'
...
module.exports = Backbone.View.extend({
	...
	render: function render() {
		...
		if (this.options.headerImg) {
			...
			if (this.options.icon == 'headerImg') this.$headerImg.addClass('icon');else if (this.options.icon) this.$headerImg.addClass('bgd');
		}
		...
		if (this.options.icon && this.options.icon != 'headerImg') this.$icon.addClass('icon-' + this.options.icon);
	...
	isActiveModal: function isActiveModal() {
	...
	open: function open(opts) {
		...
		setTimeout(_.bind(function () {
			...
			if (this.options.icon) this.$icon.addClass('animated speed-2 flipInY');
	...
	renderTitle: function renderTitle() {
		...
		if (!this.options.title) return this.$title.hide();else this.$title.show();
	...
	renderContent: function renderContent() {
		...
		if (!this.options.msg && !this.options.view) return this.$content.hide();else this.$content.show();

		var view = this.options.view || this.options.msg;
	...
	renderBtns: function renderBtns() {
		...
		if (!this.options.btns) return this.$btns.hide();else this.$btns.show();

		if (_.isString(this.options.btns)) this.renderBtn(this.options.btns);else _.each(this.options.btns, this.renderBtn, this);
	},

	renderBtn: function renderBtn(btnOpts) {
		var $btn = this.makeBtn(btnOpts);

		this.$btns.append($btn);
	},

	renderHide: function renderHide() {
		if (this.options.hide) this.$checkbox.append($('<input type="checkbox"/><span class="hide-message">' + this.options.hideMessage + '</span>'));
	},

	makeBtn: function makeBtn(opts) {

		if (_.isFunction(opts)) opts = opts.call(this);

		if (opts === 'close') opts = { label: 'Close', className: 'md-close', eventKey: this.options.btns.length == 1 ? ['esc', 'enter'] : 'esc' };else if (opts === 'cancel') opts = { label: 'Cancel', className: 'md-close', eventKey: 'esc', onClick: this.triggerCancel.bind(this) };else if (opts === 'ok') opts = { label: 'Ok', className: 'md-close', eventKey: ['esc', 'enter'] };else if (opts === 'done') opts = { label: 'Done', className: 'md-close', eventKey: ['esc', 'enter'] };else if (opts === 'dismiss') opts = { label: 'Dismiss', className: 'black md-close', eventKey: ['esc', 'enter'] };
		...
		if (opts.onClick) {
			var onClick = opts.onClick.bind(opts);
			var backboneView = this.options.view || this.options.msg;

			if (_.isString(opts.onClick) && backboneView instanceof Backbone.View && _.isFunction(backboneView[opts.onClick])) {
	...
	_eventKeyFn: function _eventKeyFn(eventKey, $btn, e) {
	...
	spinner: function spinner() {
		...
		_.defer(function () {
			// we defer so the auto centering of the spinner works
			var s = new Spinner().spin(self.$title[0]);
			console.log(s);
			// self.$title.spin();
		});
		return this;
	...
	attention: function attention(animation) {
		var self = this;
		...
		_.defer(function () {
			self.$el.addClass('animated ' + animation);
		});
	},

	shake: function shake() {
		this.attention('shake');
	},
	wobble: function wobble() {
		this.attention('wobble');
	},
	pulse: function pulse() {
		this.attention('pulse');
	},
	bounce: function bounce() {
		this.attention('bounce');
	},
	flash: function flash() {
		this.attention('flash');
	},
	swing: function swing() {
		this.attention('swing');
	},
	tada: function tada() {
		this.attention('tada');
	},
	...
	progress: function progress(num) {
		if (num >= 0) this.$progress.show().width(num + '%');
...
},{"spin.js":"../node_modules/spin.js/spin.js","./settings":"../src/settings.js"}],"../src/presets/spinner.js":[function(require,module,exports) {
...
},{}],"../src/presets/progress.js":[function(require,module,exports) {
...
module.exports = function () {
	...
	var _args$reverse2 = _slicedToArray(_args$reverse, 2);

	msg = _args$reverse2[0];
	title = _args$reverse2[1];
...
},{}],"../src/presets/alert.js":[function(require,module,exports) {
...
},{}],"../src/presets/warn.js":[function(require,module,exports) {
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();
...
},{}],"../src/presets/success.js":[function(require,module,exports) {
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();
...
},{}],"../src/presets/error.js":[function(require,module,exports) {
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();
...
},{}],"../src/presets/confirm.js":[function(require,module,exports) {
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();
...
module.exports = function () {
	...
	var _args$reverse2 = _slicedToArray(_args$reverse, 3);

	callback = _args$reverse2[0];
	msg = _args$reverse2[1];
	title = _args$reverse2[2];
	...
	return new Modal({
		...
		btns: [{
			...
			onClick: callback || function () {
				alert('Please provide a callback');
			},
			eventKey: 'enter'
		}, 'cancel']
	});
};
},{}],"../src/presets/confirmDelete.js":[function(require,module,exports) {
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();
...
},{}],"../src/presets/select.js":[function(require,module,exports) {
...
module.exports = function (title, values, callback) {
	...
	_.each(values, function (value, indx) {
		...
		if (['ok', 'cancel', 'close', 'dismiss'].includes(value)) return;
	...
	function watchKeyPress(e) {
		...
		if (found && e.which == 13) return found.click();else if (found) found.style.backgroundColor = '';
		...
		if (e.which >= 65 && e.which <= 90) typedChars += String.fromCharCode(e.which);

		found = null;
		var pattern = new RegExp('^' + typedChars);

		if (typedChars) modal.$btns[0].querySelectorAll('a').forEach(function (el) {
	...
	if (modal.$btns[0].scrollHeight > modal.$btns[0].clientHeight) document.addEventListener('keydown', watchKeyPress);

	return modal;
};
},{}],"../src/presets/prompt.js":[function(require,module,exports) {
...
module.exports = function (title, msg, opts, callback) {
	...
	switch (regex) {
		case 'required':
			regex = '.+';break;
		case 'hexcode':
			regex = '^#?([A-Za-z0-9]{6}|[A-Za-z0-9]{3})$';break;
		case 'string':
			regex = '^.+';break;
		case 'int':
		case 'integer':
	...
	var attr = _.map(opts.attr, function (v, k) {
		return k + '="' + v + '"';
	}).join(' ');

	if (useTextarea) prompt += '<textarea placeholder="' + opts.placeholder + '" ' + attr + ' class="prompt" style="width:' + opts.w + 'px;height: ' + opts.h + 'px">' + opts.val + '</textarea>';else prompt += '<input value="' + opts.val + '" placeholder="' + opts.placeholder + '" ' + attr + ' class="prompt" type="' + (opts.password ? 'password' : opts.inputType) + '" style="width:' + opts.w + 'px;">';

	if (opts.prefix) prompt = '<span class="md-prefix" style="height: ' + opts.h + 'px">' + opts.prefix + '</span>' + prompt;

	if (opts.suffix) prompt += '<span class="md-suffix" style="height: ' + opts.h + 'px">' + opts.suffix + '</span>';
	...
	var modal = new Modal({
		...
		btns: [{
			...
			onClick: function onClick(e) {
				...
				if (!callback) return alert('Please provide a callback');
				...
				if (regex && !regex.test(val)) {
					...
					if (opts.pattern == 'hexcode' && val.charAt(0) !== '#') val = '#' + val;

					if (callback(val, e) !== false) modal.close();
				}
			},
	...
	modal.getValue = function () {
		var val = modal.$('.prompt').val();
		if (regex && !regex.test(val)) val = false;
		return val;
	};

	if (opts.autoFocus !== false) setTimeout(function () {
		modal.$('.prompt').focus().select();
	}, 250);

	return modal;
};
},{}],"../src/presets/img.js":[function(require,module,exports) {
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();
...
var ModalController = require('./controller');
var Modal = require('./modal');

// initialize a controller
var modalController = Modal.prototype.controller = new ModalController();

Modal.close = function (opts) {
	modalController.closeAll();Modal.SPINNER = null;
};
Modal.isOpen = function (opts) {
	return modalController.modals.length > 0;
};
...
},{"./controller":"../src/controller.js","./modal":"../src/modal.js","./presets/spinner":"../src/presets/spinner.js","./presets/progress":"../src/presets/progress.js","./presets/alert":"../src/presets/alert.js","./presets/warn":"../src/presets/warn.js","./presets/success":"../src/presets/success.js","./presets/error":"../src/presets/error.js","./presets/confirm":"../src/presets/confirm.js","./presets/confirmDelete":"../src/presets/confirmDelete.js","./presets/select":"../src/presets/select.js","./presets/prompt":"../src/presets/prompt.js","./presets/img":"../src/presets/img.js"}],"index.js":[function(require,module,exports) {
...
spinnerBtnMsg = function spinnerBtnMsg() {
    new Modal({ title: 'spinner', msg: 'Waiting for response', btns: ['cancel'] });
};

progressBtn = function progressBtn() {
...
iconBtn = function iconBtn() {
    new Modal({ title: 'Modal with Icons', msg: '', btns: [{ label: '', className: 'md-close icon-user-add green' }, { label: '', className: 'md-close icon-trash red' }, { label: '', className: 'md-close icon-ccw' }] });
};
...
imgHeaderWithIcon = function imgHeaderWithIcon() {
    new Modal({
        headerImg: 'http://kevinjantzer.com/wp-content/uploads/2013/08/Hamaker-Woods-2013.jpg',
        title: 'Delete Image?',
        icon: 'trash'
...
effectBtn = function effectBtn(effect) {
    new Modal({
...
},{"jquery":"../node_modules/jquery/dist/jquery.js","underscore":"../node_modules/underscore/underscore.js","backbone":"../node_modules/backbone/backbone.js","../src":"../src/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/demo.b8c1a5e0.map